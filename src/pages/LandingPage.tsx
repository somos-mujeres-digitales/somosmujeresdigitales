        ...
        <div className="section-container">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {problems.map((problem, index) => (
              <div
                key={index}
                className="dashboard-card text-center card-hover"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4">
                {[
                  'Algoritmo que analiza etapa, objetivos e intereses',
                  'Mentoras verificadas con experiencia real en STEM',
                  'Sesiones 1:1 enfocadas en tus decisiones específicas',
                  'Seguimiento y planes de acción personalizados',
                ].map((item, index) => (
            ...
            <div className="grid grid-cols-2 gap-4">
              {mentoras.slice(0, 4).map((mentora, index) => (
                <div
                  key={mentora.id}
                  className={`dashboard-card card-hover ${index === 0 ? 'col-span-2' : ''}`}
                >
                  <div className="flex items-center gap-3">
                    <img
                      src={mentora.imageUrl}
                      alt={mentora.name}
        ...
        <div className="section-container">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial) => (
              <div key={testimonial.id} className="dashboard-card card-hover">
        ...
        <div className="section-container text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              ...
              onClick={() => navigate('/para-mentoras')}
            >
